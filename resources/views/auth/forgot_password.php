...
<head>
    ...
    <title>Şifremi Unuttum - SaintMonarc</title>
...
<body>
    <div class="container">
        <div class="card">
            ...
            <p class="desc">Hesabınıza ait e-posta adresinizi girin, şifre sıfırlama bağlantısını oluşturalım.</p>
            ...
            <div class="links">
                Hatırladınız mı? <a href="<?= url('/login') ?>">Giriş Yap</a>
            </div>
        </div>
    </div>
</body>
