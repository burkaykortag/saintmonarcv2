<?php
$title = "Arama Sonuçları - SaintMonarc";

?>

<div class="container py-4 text-dark">
    <!-- Search Summary Header -->
    <div class="bg-white p-4 rounded-4 border border-secondary border-opacity-10 shadow-sm mb-4">
        <h3 class="font-weight-800 m-0" style="font-weight: 800;">"<?= htmlspecialchars($query ?? '') ?>" Arama Sonuçları</h3>
        <p class="text-muted mb-0 fs-7">Sistem genelinde aramanızla eşleşen sonuçlar listeleniyor.</p>
    </div>
