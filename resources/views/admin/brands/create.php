...
$title = "Marka Ekle - SaintMonarc";
include dirname(__DIR__) . '/layouts/header.php';
?>

<div class="mb-4">
    <?= ComponentHelper::breadcrumb(['Yönetim Paneli' => url('/admin'), 'Katalog' => '#', 'Markalar' => url('/admin/brands'), 'Yeni Marka' => '#']) ?>
    <h2 class="mt-2 text-white font-weight-700 m-0" style="font-size: 26px;">Yeni Marka Ekle</h2>
</div>
...
<form action="<?= url('/admin/brands/create') ?>" method="POST" class="row g-4">
        ...
        <div class="card p-4 border-0 mb-4" style="background: rgba(255,255,255,0.02); border: 1px solid var(--sm-border) !important; border-radius: 20px;">
            ...
            <div class="row g-3 mb-3">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="name" required class="form-control border-0 text-white" style="background: rgba(255,255,255,0.03); border: 1px solid var(--sm-border) !important; padding: 12px;" placeholder="Örn: Nike">
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label text-muted fs-7 mb-1">Resmi Web Sitesi</label>
                    <input type="url" name="website" class="form-control border-0 text-white" style="background: rgba(255,255,255,0.03); border: 1px solid var(--sm-border) !important; padding: 12px;" placeholder="https://nike.com">
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label text-muted fs-7 mb-1">Kısa Açıklama</label>
                <input type="text" name="short_description" class="form-control border-0 text-white" style="background: rgba(255,255,255,0.03); border: 1px solid var(--sm-border) !important; padding: 12px;" placeholder="Sosyal paylaşımlar ve listelemeler için kısa slogan...">
            </div>

            <div class="mb-3">
                <label class="form-label text-muted fs-7 mb-1">Detaylı Açıklama (CMS & Marka Sayfası)</label>
                <textarea name="description" class="form-control border-0 text-white" rows="6" style="background: rgba(255,255,255,0.03); border: 1px solid var(--sm-border) !important; resize:none;" placeholder="Markaya ait kurumsal detaylı açıklama giriniz..."></textarea>
            </div>
        </div>
        ...
        <div class="card p-4 border-0 mb-4" style="background: rgba(255,255,255,0.02); border: 1px solid var(--sm-border) !important; border-radius: 20px;">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="seo[keywords]" class="form-control border-0 text-white fs-7" style="background: rgba(255,255,255,0.03); border: 1px solid var(--sm-border) !important;">
                </div>
                <div class="col-12">
    ...
    <div class="col-12 col-xl-4">
        ...
        <div class="card p-4 border-0 mb-4" style="background: rgba(255,255,255,0.02); border: 1px solid var(--sm-border) !important; border-radius: 20px;">
            ...
            <div class="d-flex flex-column gap-2">
                <button type="submit" class="btn w-100 py-3">Markayi Kaydet</button>
